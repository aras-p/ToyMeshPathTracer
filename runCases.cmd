@echo off
(build\x64-Release\TrimeshTracer.exe 640 360 4 data/triangle.obj) && (move /Y output.png output1Triangle.png)
...
rem (build\x64-Release\TrimeshTracer.exe 640 360 4 data/teapot.obj) && (move /Y output.png output4Teapot.png)
